...
<html lang="en">
    ...
    <head>
        ...
        <style>
            .fix{
                width: 350px;
                height: 300px; /* Chiều cao bạn muốn đặt */
                object-fit: cover; /* Đảm bảo ảnh không bị méo khi chiều rộng và chiều cao không khớp tỷ lệ khung hình */
            }
        </style>
    </head>
                            ...
                            <section>
                                ...
                                <section class="mb-4">
                                    ...
                                    <div class="form-check pl-0 mb-3">
                                        <input onchange="searchByPriceUnder20()" type="radio" class="form-check-input" id="under100" name="materialExampleRadios">
                                        <label class="form-check-label small text-uppercase card-link-secondary" for="under100">Under
                                            $20</label>
                                    </div>
                                    <div class="form-check pl-0 mb-3">
                                        <input onchange="searchByPrice20To25()" type="radio" class="form-check-input" id="100200" name="materialExampleRadios">
                                        <label class="form-check-label small text-uppercase card-link-secondary" for="100200">$20 to
                                            $25</label>
                                    </div>
                                    <div class="form-check pl-0 mb-3">
                                        <input onchange="searchByPriceAbove25()" type="radio" class="form-check-input" id="200above" name="materialExampleRadios">
                                        <label class="form-check-label small text-uppercase card-link-secondary" for="200above">$25 &
                                            Above</label>
                                    </div>
                                    <form>
...
<!--                                    <h6 class="font-weight-bold mb-3">Sort By Price</h6>
                                    <div>
                                         <a href="sort" class="btn btn-flat btn-md px-3 waves-effect"><i class="fas fa-search fa-lg"></i></a>
                                    </div>-->
                                </section>
                                <!-- Section: Price -->
                                ...
                                <c:forEach items="${listP}" var="o">
                                    ...
                                    <div class="col-md-4 mb-5">
                                        ...
                                        <div class="view zoom overlay rounded z-depth-2">
                                            <img class="img-fluid w-100 fix"src="image/${o.image }" alt="Sample">
                                            <a href="detail?pid=${o.id}">
                                                <div class="mask">
                                                    <img class="img-fluid w-100 fix" src="image/${o.image }">
                    ...
                    <script>
                                            ...
                                            function load(cateid) {
                                                $.ajax({
                                                    url: "/Project_Ban_Che/categoryShop",
                                            ...
                                            function searchByName(param) {
                                                ...
                                                $.ajax({
                                                    url: "/Project_Ban_Che/searchAjaxShop",
                                                    type: "get", //send it through get method
                                                    data: {
                                                        txt: txtSearch
                                                    },
                                            ...
                                            function searchByPriceMinToMax() {
                                                ...
                                                $.ajax({
                                                    url: "/Project_Ban_Che/searchAjaxPriceMinToMax",
                                                    type: "get", //send it through get method
                                                    data: {
                                                        priceMin: numMin,
                                                        priceMax: numMax
                                            ...
                                            function searchByPriceUnder20() {
                                                $.ajax({
                                                    url: "/Project_Ban_Che/searchAjaxPriceUnder100Shop",
                                                    type: "get", //send it through get method
                                                    data: {
                                            ...
                                            function searchByPrice20To25() {
                                                $.ajax({
                                                    url: "/Project_Ban_Che/searchAjaxPrice100To200Shop",
                                                    type: "get", //send it through get method
                                                    data: {
                                            ...
                                            function searchByPriceAbove25() {
                                                $.ajax({
                                                    url: "/Project_Ban_Che/searchAjaxPriceAbove200Shop",
                                                    type: "get", //send it through get method
                                                    data: {
