    ...
    <head>
        ...
        <style>
            ...
            .carousel-item:nth-child(1) {
                background-image: url('image/food-banner-clipart-2.jpg');
            ...
            .carousel-item:nth-child(2) {
                background-image: url('image/food-banner-background-g4msl.webp');
                background-repeat: no-repeat;
                background-size: 100% 100%;
                background-position: center center;
            }
    ...
    <body class="skin-light" onload="loadAmountCart()">
        <jsp:include page="Menu.jsp"></jsp:include>
            ...
            <div class="container">
                <div class="row" style="margin-top:25px">            
                    <h1 style="text-align:center; width:100%" id="moiNhat">SẢN PHẨM ĐỘC ĐÁO</h1>
                    <div class="col-sm-12">
                            ...
                            <div class=" col-12 col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="view zoom z-depth-2 rounded ">
                                        <img class="img-fluid w-100 img-fixed-size" src="image/${o.image}" alt="Card image cap">
            ...
            <div class="row" style="margin-top:25px">            
                <h1 style="text-align:center; width:100%" id="nike">Món Trà Mới Nhất</h1>
                <div class="col-sm-12">
                    <div id="contentNike" class="row">
                        <c:forEach items="${list4TraLast}" var="o">
                    ...
                    <button onclick="loadTra()" class="btn btn-primary">Load more</button>
                </div>
            </div>


            <div class="row" style="margin-top:25px">            
                <h1 style="text-align:center; width:100%" id="adidas">Món Chè Mới Nhất</h1>
                <div class="col-sm-12">
                    <div id="contentAdidas" class="row">
                        <c:forEach items="${listChe4Last}" var="o">
                    ...
                    <button onclick="loadChe()" class="btn btn-primary">Load more</button>
                </div>
            </div>
                    ...
                    <div id="content" class="row">
                        <div class=" col-12 col-md-12 col-lg-6">
                            <div class="card-body">
                                ...
                                <h2 class="card-title show_txt" style="text-align:center; font-size:24pt;">Ốc Chè Ngon Shop</h2>
                                <p style="text-align:center;">Uy tín tạo thương hiệu, luôn mang lại cho thực khách những trải nghiệm tuyệt vời nhất.</p>
                                <p> Hãy đến với Ốc Chè Ngon Shop – nơi bạn luôn thoả mãn mĩ vị.</p>                  
                            </div>  
                        </div>
                        <div class="col-12 col-md-12 col-lg-6">
                            <img class="card-img-top" src="image/banner2.jpg" alt="Card image cap">        
                        </div>
        ...
        <script>
                        ...
                        function searchByName(param) {
                            ...
                            $.ajax({
                                url: "/Project_Ban_Che/searchAjax",
                                type: "get", //send it through get method
                                data: {
                                    txt: txtSearch
                                },
