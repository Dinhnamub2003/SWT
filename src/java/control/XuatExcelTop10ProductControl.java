...
public class XuatExcelTop10ProductControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listAllProduct = pd.getAllProduct();
        ...
        FileOutputStream file=new FileOutputStream("C:\\Temp Excel\\"+"top-10-san-pham-ban-chay-"+Integer.toString(randomNum)+".xlsx");
