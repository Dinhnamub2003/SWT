...
@WebServlet(name = "LoadMoreNikeControl", urlPatterns = {"/loadTra"})
public class LoadMoreTraControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = d.getNext4TraProduct(iamount);
