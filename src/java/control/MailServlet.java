...
public class MailServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String add = "exam5266@gmail.com";// Thay bằng request.getParameter("contactmail");
        
        //
        String user = "quyendinhnam.ub2003@gmail.com";
        String pass = "qjzu gbob gkst hmxw";
        ...
        try {
            ...
            message.setContent("<h2>Cảm ơn bạn đã mua hàng</h2>", "text/html");
