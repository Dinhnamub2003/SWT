...
public class DetailControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int cateIDProductDetail = d.getCateIDByProductID(id);
        List<Product> listRelatedProduct = d.getRelatedProduct(cateIDProductDetail);
        
        List<Review> listAllReview = dal.getAllReviewByProductID(id);
        int countAllReview = listAllReview.size();
        
        List<Account> listAllAcount = dal.getAllAccount();
