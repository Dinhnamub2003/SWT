...
@WebServlet(name = "LoadMoreAdidasControl", urlPatterns = {"/loadChe"})
public class LoadMoreCheControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     ProductDAO d = new ProductDAO();
        List<Product> list = d.getNext4CheProduct(iamount);
        ...
        for (Product o : list) {
            out.println(" <div class=\"productAdidas col-12 col-md-6 col-lg-3\">\r\n"
            		...
            		+ "                                    <img class=\"img-fluid w-100 img-fixed-size\" src=\"image/"+o.getImage()+"\" alt=\"Card image cap\">\r\n"
            		+ "                                    </div>\r\n"
            		+ "                                    <div class=\"card-body\">\r\n"
